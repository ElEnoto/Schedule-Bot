...
<div class="p-3">
    <form action="/?action=download_event" method="post" enctype="multipart/form-data" class="w-25">
        ...
        ?>name="add_change" name="finish_change" value="Завершить редактирование" <?php } else { ?> name="add" value="Отправить расписание" <?php } ?>>
    </form>
        ...
        <table class="table table-hover">
            ...
            foreach ($this->content as $item) { ?>
                <tr class="text-center">
                    ...
                    <td><?= $item['comment'] ?></td>
                    <td>
                        <input type="checkbox" class="form-check-input" name="id_event[]"
                               value="<?= $item['id_event'] ?>">
                    </td>
                </tr>
            <?php } ?>
